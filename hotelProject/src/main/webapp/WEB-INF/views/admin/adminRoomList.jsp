            ...
            <div class="row">
            	...
            	<div  class="col-xs-12 col-md-10 review">
                    ...
                    <div class="titlebox">
                      ...
                      <div class="btnBox">
                          <button type="button" class="btn btn-info" onclick="location.href='adminRoomRegist'">객실 추가</button>
                      </div>
                    </div>  
                </div>
            </div>
    			...
    			$.getJSON(
    				...
    				function(data){
    					...
    					for(var i=0;i<data.length;i++){
    						...
    						str += "<tr>";
    						str += "<td>"+(i+1)+"</td>";
    						str += "<td><a href='adminRoomDetail?hotelName="+data[i].hotelName+"'>"+data[i].hotelName+"</a></td>";
    						str += "</tr>";
    					}
    					$("#tableTbody").html(str);
    				}
